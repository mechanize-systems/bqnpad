...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_cbqn_runLine')) {
        Object.defineProperty(Module['ready'], '_cbqn_runLine', { configurable: true, get: function() { abort('You are getting _cbqn_runLine on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_cbqn_runLine', { configurable: true, set: function() { abort('You are setting _cbqn_runLine on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_cbqn_evalSrc')) {
        Object.defineProperty(Module['ready'], '_cbqn_evalSrc', { configurable: true, get: function() { abort('You are getting _cbqn_evalSrc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_cbqn_evalSrc', { configurable: true, set: function() { abort('You are setting _cbqn_evalSrc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var dynCall_ijjjjj = Module["dynCall_ijjjjj"] = createExportWrapper("dynCall_ijjjjj");
...
function invoke_ijjjjj(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) {
  var sp = stackSave();
  try {
    return dynCall_ijjjjj(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
